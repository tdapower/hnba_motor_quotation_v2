...
export class QuotationAddComponent implements OnInit {
  ...
  public getQuotation() {
    ...
    this.quotationService.getQuotation(objViewQuotation)
      .subscribe((data) => {
        // console.log(data);
        var blob = new Blob([data], { type: 'application/pdf' });
        // console.log(blob);
  ...
  public sendMRApprovalRequest() {
    ...
    this.quotationService.sendMRApprovalRequest(objMRApproval).subscribe((data: any) => {
